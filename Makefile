...
test:
	...
	cd build&g++ -I../src -I../thirdparty -I$(PYTHON_PATH)/include/ -DPYTHON=$(PYTHON_VERSION)    -I $(PYTHON_PATH)/Lib/site-packages/~umpy/core/include  -g -o draw.exe $(PYTHON_PATH)/python3$(PYTHON_VERSION).dll a.tab.cc a.yy.cc ../src/test.cpp
